<template>
  <div class="main-container">
    ...
    <Breadcrumbs :items="breadcrumbNavigation" breadcrumb-title="Blog Details" />
                ...
                <div class="post-info lg-blog-post-info">
                  ...
                  <div class="post-meta mt-20 justify-content-center">
                    ...
                    <div class="post-comments">
                      <span class="far fa-comment-alt meta-icon" />
                      <n-link to="/" class="smooth-scroll-link">
                        4 Comments
                      </n-link>
                    </div>
                  </div>
...
export default {
  ...
  mounted () {
    this.data = data.blogPosts.find(blog => blog.id === this.$route.params.id)
  }
}
</script>
