      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-title-wrap text-center">
            <h3 class="heading" v-html="data.serviceOne.sectionTitle">
              {{ data.serviceOne.sectionTitle }}
            </h3>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12">
          <div class="feature-images__one">
            <div class="row">
              <div v-for="service in data.services.slice(0, 6)" :key="service.id" class="col-lg-4 col-md-6 wow move-up">
